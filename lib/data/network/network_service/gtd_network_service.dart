  ...
  Future<Response> uploadMedia({
    ...
    try {
      ...
      FormData formData = FormData.fromMap({
        "multipartImage": MultipartFile.fromBytes(request.file!,
            filename: "image-${UniqueKey()}", contentType: DioMediaType("image", "jpeg")),
        "description": "Upload image", // Add additional fields if needed
      });
      final Response response = await _dio.requestUri(
        request.buildUri(),
        data: formData,
