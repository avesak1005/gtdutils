...
enum GtdErrorConstant {
  ...
  paymentBalPurchasingPowerIncorrect(
      -6211, "6_PAYMENT_BAL_PURCHASING_POWER_INCORRECT", "Quá hạn mức, vui lòng kiểm tra tài khoản của bạn."),
  ...
  insuranceFlexiFailed(14001, "FLEXI_INSURANCE_FAILED",
      "Đăng ký bảo hiểm du lịch không thành công! Vui lòng liên hệ bộ phận CSKH Gotadi.com 1900-9002 để được hỗ trợ."),
  ...
  static GtdErrorConstant findByCode({String? id, String? code}) {
    GtdErrorConstant? error = GtdErrorConstant.values
        .where((element) =>
            "${element.id}" == id || element.code.toLowerCase() == code?.toLowerCase() || element.code == id)
        .firstOrNull;
