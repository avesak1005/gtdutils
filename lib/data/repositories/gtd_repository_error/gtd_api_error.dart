...
import '../../network/network_service/gtd_error_message.dart';
...
class GtdApiError implements Exception {
  ...
  static GtdApiError fromErrorConstant(GtdErrorConstant errorConstant) {
    var message = getErrorMessage(errorId: errorConstant.code, errorMessage: errorConstant.message);
    return GtdApiError(message: message, code: errorConstant.code);
  }
