...
class GtdFlightItem {
  ...
  GtdFlightItem copyWith(
    ...
    item.flightItemInfo = flightItemInfo ?? flightItemInfo;
  ...
  List<GtdFlightItem> splitCabinClass() {
    var items = (cabinOptions ?? []).map((cabinOption) {
      var flightItemInfo = this.flightItemInfo?.copyWith(
          originDateTime: cabinOption.originDateTime,
          destinationDateTime: cabinOption.destinationDateTime,
          journeyDuration: cabinOption.journeyDuration);
      GtdFlightItem item = copyWith(cabinOptions: [cabinOption], flightItemInfo: flightItemInfo);
      return item;
    }).toList();
