...
class GtdAirlineCabinClass {
  ...
  factory GtdAirlineCabinClass.fromPricedItinerary(PricedItinerary pricedItinerary, FlightDirection flightDirection) {
    ...
    airlineCabinClass.flightSegments = originDestinationOption?.flightSegments;
    airlineCabinClass.journeyDuration = originDestinationOption?.journeyDuration;
    airlineCabinClass.originDateTime = originDestinationOption?.originDateTime;
    airlineCabinClass.destinationDateTime = originDestinationOption?.destinationDateTime;
