...
class AirTicketResourceApi {
  ...
  Future<GtdFlightFareRulesRs> flightFareRules(String bookingNumber) async {
    try {
      ...
      Logger.e("Error flightFareRules: $e");
      throw GtdApiError.handleObjectError(e);
    }
  }

  Future<List<FareRule>> searchingflightFareRules(String fareSourceCode, String groupId, String searchId) async {
    try {
      var requestParams = {"fareSourceCode": fareSourceCode, "groupId": groupId, "searchId": searchId};
      final networkRequest = GTDNetworkRequest(
          type: GtdMethod.post,
          enpoint: AirTicketApiEndpoint.searchingFlightFareRule(envType),
          queryParams: {"language": "vi"},
          data: requestParams);
      networkService.request = networkRequest;
      final Response response = await networkService.execute();
      final List<FareRule> flightFareRulesRs =
          JsonParser.jsonArrayToModel(FareRule.fromJson, response.data['fareRules']);
      return flightFareRulesRs;
    } on DioException catch (e) {
      Logger.e('Trace: ${e.stackTrace} \nErrorMess: ${e.toString()}');
      GtdDioException dioException = GtdDioException.fromDioError(e);
      ...
      Logger.e("Error searchingflightFareRules: $e");
      throw GtdApiError.handleObjectError(e);
    }
  }
}
