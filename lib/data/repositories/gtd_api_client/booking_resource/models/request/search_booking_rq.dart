...
class SearchBookingRq {
  ...
  factory SearchBookingRq.initSearchBookingRq() => SearchBookingRq(supplierType: 'AIR', page: 0, size: 10);
  ...
  factory SearchBookingRq.fromJson(Map<String, dynamic> json) => SearchBookingRq(
        ...
        toDate: json["toDate"],
        listBookingStatus:
            json["listBookingStatus"] == null ? null : List<String>.from(json["listBookingStatus"]?.map((x) => x)),
        page: json["page"],
        size: json["size"],
  ...
  Map<String, dynamic> toB2BRequest() => {
        "productCode": supplierType,
        "bookingNumber": bookingNumber,
        "fromDate": fromDate,
        "toDate": toDate,
        "status": listBookingStatus == null ? null : List<dynamic>.from(listBookingStatus!.map((x) => x)),
        "page": page,
        "size": size,
        "ignoreSummary": true,
