...
const String shortDateTimePattern = "EEE dd/MM/yyyy";
const String normalDateTimePattern = "HH:mm dd/MM/yyyy";
DateFormat dateFormat = DateFormat("dd/MM/yyyy");
DateFormat dateFormatFlight = DateFormat("HH:mm - EEEE, dd/MM/yyyy");
DateFormat dateFormatHotel = DateFormat("EEE, dd/MM/yyyy");
...
extension GtdDateTime on DateTime {
  ...
  String localDate(String pattern, {String lang = "vi"}) {
    try {
      ...
      DateFormat dateFormat = DateFormat(pattern, cachedLanguageCode);
