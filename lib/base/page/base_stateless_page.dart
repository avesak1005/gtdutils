...
class BaseStatelessPage<T extends BasePageViewModel> extends StatelessWidget {
  ...
  AppBar? buildAppbar(BuildContext pageContext) {
    return AppBar(
      ...
      elevation: 0,
      backgroundColor: viewModel.appBarColor ?? Colors.white,
              ...
              : Column(
                  children: [
                    (viewModel.title != null)
                        ? Text(
                            viewModel.title!,
                            style: TextStyle(fontSize: 17, color: viewModel.titleColor),
                          )
                        : const SizedBox(),
      ...
      iconTheme: IconThemeData(color: viewModel.titleColor ?? Colors.black),
